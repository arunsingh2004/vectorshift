...
CLIENT_ID='bc9e7a7f-9455-4cce-af89-a6402cc7509a'
CLIENT_SECRET='58e3568e-5b06-4897-ad99-41eb23ce2825'

# Access permissions
SCOPE='oauth crm.objects.contacts.read'

encoded_scopes = quote(SCOPE, safe="")
...
async def authorize_hubspot(user_id, org_id):
    ...
    auth_url = f'{AUTHORIZATION_URI}?client_id={CLIENT_ID}&redirect_uri={REDIRECT_URI}&scope={encoded_scopes}&state={encoded_state}'
